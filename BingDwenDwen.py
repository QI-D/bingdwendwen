...
# five circle
three_circle_height = -165
two_circle_height = -170
circle_radius = 6

turtle.penup()
turtle.goto(-18, three_circle_height)
turtle.pendown()
turtle.pencolor("blue")
turtle.circle(circle_radius)
turtle.penup()
turtle.goto(-3, three_circle_height)
turtle.pendown()
turtle.pencolor("black")
turtle.circle(circle_radius)
turtle.penup()
turtle.goto(12, three_circle_height)
turtle.pendown()
turtle.pencolor("brown")
turtle.circle(circle_radius)
turtle.penup()
turtle.goto(-11, two_circle_height)
turtle.pendown()
turtle.pencolor("lightgoldenrod")
turtle.circle(circle_radius)
turtle.penup()
turtle.goto(3, two_circle_height)
turtle.pendown()
